...
var arraySum = function(array) {
  if(array.length === 0){
    ...
    let add = Array.isArray(array[0]) ? arraySum(array[0]) : array[0];
    return add + arraySum(array.slice(1));
  }
};
...
var exponent = function(base, exp) {
  ...
  if(exp < 0){ return exponent(base, exp + 1) * 1 / base; }
